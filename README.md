...
Bug reports and clarifications — open an issue. Proposed changes — open a pull request. Breaking change proposals — open an issue for discussion before writing spec text.
